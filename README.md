...
- [💠 Qwind](#-qwind)
  ...
  - [Getting started](#getting-started)
    - [Developing with Nix](#developing-with-nix)
...
Copy the **flake.nix** and rust-toolchain files from the [official Qwik repo](https://github.com/QwikDev/qwik) and add them to git (otherwise nix will ignore them). Then enable the flake ("use flake") with [direnv](https://github.com/nix-community/nix-direnv).
